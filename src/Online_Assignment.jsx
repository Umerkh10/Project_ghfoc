...
const Online_Assignment = () => {
  ...
  return (
    ...
    <>
         <Helmet>
        <meta charSet="utf-8" />
        <title>Online Assignment | Get Help For Online Class</title>
        ...
        <div className="container">
          ...
          <div className="col-lg-4 mt-3">
            <div className='banner-text text-md-left '>
                <h1 className='sec-1-head'>Online Assignment Help for All Academic Levels with<span className='text-blue'> Phd Experts</span></h1>
              <div className='sec-1-para'>
                <p> Online Assignment Help for Me offers assistance with <span className='text-blue-bg'> all courses </span> at all <span className='text-blue-bg'> academic levels. </span> Score your <span className='text-blue-bg'> desired marks </span> with a team of top-tier academic instructors at the most <span className='text-blue-bg'> affordable price.</span>  </p>
              </div>
              <div className='btn'>
...
export default Online_Assignment