...
import Sub_sec from './assets/project imgs/sub-sec-transformed.webp'
...
const Subject = () => {
  return (
    <div>
      ...
      <div className="sub-sec-2 mt-3">
        <div className="container">
          <h5 className='head-2'>Our Subjects</h5>
          <h3 className='head-3'>Explore From <span className='text-blue'> 70+ Subjects. </span> </h3>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3 col-6">
                    <li>
                      <div className="sub-box my-3">
                        <div className="sub-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-brain"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z" /><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z" /><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4" /><path d="M17.599 6.5a3 3 0 0 0 .399-1.375" /><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5" /><path d="M3.477 10.896a4 4 0 0 1 .585-.396" /><path d="M19.938 10.5a4 4 0 0 1 .585.396" /><path d="M6 18a4 4 0 0 1-1.967-.516" /><path d="M19.967 17.484A4 4 0 0 1 18 18" /></svg>                        </div>
                        <h5>Psychology</h5>
                      </div>
                    </li>
                  </div>
                  ...
                  <div className="col-lg-3 col-6">
                    <li>
                      <div className="sub-box my-3">
                        <div className="sub-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-radical"><path d="M3 12h4l3 9 4-17h7"/></svg>
                       </div>
                        <h5>Algebra</h5>
                      </div>
                    </li>
      ...
      <div className="exam-sec mt-3" style={{backgroundImage:`url(${background})` , backgroundSize:`cover`,backgroundPosition:`center` }} >
        <div className="overlay">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-12">
                <div className="exam-main my-5">
                  <h3>Hire a Phd Qualified Professional to take your Class</h3>
                  <h4>Get Online Class Help Now & And Get Your Desired Grade At Affordable Pricing!</h4>
                  <a href="javascript:void(Tawk_API.toggle())" className='btn-chat'>Chat Now
